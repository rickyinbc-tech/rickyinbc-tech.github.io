...
check(select.status === 404, "unrelated legacy hosts must fail closed");
...
check(blogAward.headers.get("location") === "https://rickykwok.com/awards-recognition/", "legacy blog redirects must be one hop and discard query parameters");
